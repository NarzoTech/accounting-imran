...
@section('user-content')
    ...
    <div class="dashboard_content">
        <h2 class="dashboard_title">{{ __('add property') }}
            <a class="common_btn" href="{{ route('website.user.property.index') }}">
                {{ __('All Properties') }}
            </a>
        </h2>
        <div class="dashboard_add_property">
            <form action="{{ route('website.user.property.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="col-xxl-4 col-md-6">
                            <div class="add_property_input">
                                ...
                                <input id="property_id" name="property_id" type="text"
                                    placeholder="{{ __('Property ID') }}" value="{{ old('property_id') }}">
                            </div>
                        </div>
                        <div class="col-xxl-4 col-md-6">
                            <div class="add_property_input">
                                ...
                                <input id="building_year" name="building_year" type="text"
                                    placeholder="{{ __('Building Year') }}" value="{{ old('building_year') }}">
                            </div>
                        </div>
                        <div class="col-xxl-4 col-md-6">
                            <div class="add_property_input">
                                ...
                                <input id="area" name="area" type="number"
                                    placeholder="{{ __('Total Area') }}" value="{{ old('area') }}" required
                                    step=".01" min="0">
                            </div>
                        </div>
                        <div class="col-xxl-4 col-md-6">
                            <div class="add_property_input">
                                ...
                                <input id="number_of_room" name="number_of_room" type="number"
                                    placeholder="{{ __('Total Rooms') }}" value="{{ old('number_of_room') }}" required
                                    min="0">
                            </div>
                        </div>
                        <div class="col-xxl-4 col-md-6">
                            <div class="add_property_input">
                                ...
                                <input id="number_of_bedroom" name="number_of_bedroom" type="number"
                                    placeholder="{{ __('Total Bed Rooms') }}" value="{{ old('number_of_bedroom') }}"
                                    required min="0">
                            </div>
                        </div>
                        <div class="col-xxl-4 col-md-6">
                            <div class="add_property_input">
                                ...
                                <input id="number_of_bathroom" name="number_of_bathroom" type="number"
                                    placeholder="{{ __('Total Bathrooms') }}" value="{{ old('number_of_bathroom') }}"
                                    required min="0">
                            </div>
                        </div>
                        <div class="col-xxl-4 col-md-6">
                            <div class="add_property_input">
                                ...
                                <input id="number_of_garage" name="number_of_garage" type="number"
                                    placeholder="{{ __('Garage') }}" value="{{ old('number_of_garage') }}" required
                                    min="0" step=".01">
                            </div>
                        </div>
                        <div class="col-xxl-4 col-md-6">
                            <div class="add_property_input">
                                ...
                                <input id="number_of_unit" name="number_of_unit" type="number"
                                    placeholder="{{ __('Units') }}" value="{{ old('number_of_unit') }}"
                                    min="0">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-4">
                            <div class="add_property_input">
                                ...
                                <textarea name="google_map_embed_code" id="google_map_embed_code" placeholder="{{ __('Location Map') }}">{{ old('google_map_embed_code') }}</textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="add_property_input">
                                <label for="description">{{ __('Description') }}<span
                                        class="text-danger">{{ __('*') }}</span></label>
                                <textarea name="description" class="summernote" id="description" placeholder="{{ __('Description') }}">{!! old('description') !!}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-xxl-4 col-md-6">
                            <div class="add_property_input">
                                ...
                                <select class="select_2" name="is_featured">
                                    <option value="0" @selected(old('is_featured') == 0)>{{ __('No') }}</option>
                                    <option value="1" @selected(old('is_featured') == 1)>{{ __('Yes') }}</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-xxl-4 col-md-6">
                            <div class="add_property_input">
                                ...
                                <select class="select_2" name="top_property">
                                    <option value="0" @selected(old('top_property') == 0)>{{ __('No') }}</option>
                                    <option value="1" @selected(old('top_property') == 1)>{{ __('Yes') }}</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-xxl-4 col-md-6">
                            <div class="add_property_input">
                                ...
                                <select class="select_2" name="urgent_property">
                                    <option value="0" @selected(old('urgent_property') == 0)>{{ __('No') }}</option>
                                    <option value="1" @selected(old('urgent_property') == 1)>{{ __('Yes') }}</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-xxl-4 col-md-6">
                            <div class="add_property_input">
                                ...
                                <textarea name="seo_title" id="seo_title" placeholder="{{ __('Seo Title') }}">{{ old('seo_title') }}</textarea>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="add_property_input">
                                <label for="seo_description">{{ __('Seo Description') }}</label>
                                <textarea name="seo_description" id="seo_description" placeholder="{{ __('Seo Description') }}" rows="7">{{ old('seo_description') }}</textarea>
