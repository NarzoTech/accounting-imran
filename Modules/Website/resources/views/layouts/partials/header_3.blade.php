            ...
            <ul class="menu_right d-flex align-items-center">
                <li>
                    <a class="user_icon"
                        ...
                        <span> <img loading="lazy" src="{{ asset('website/assets/images/user_icon_1.png') }}"
                ...
                <li class="manu_btn main_manu_btn">
                    <a class="common_btn" href="{{ route('website.user.property.create') }}"><i
                            class="fas fa-home"></i>{{ __('Add Listing') }}</a>
                </li>
                <li>
