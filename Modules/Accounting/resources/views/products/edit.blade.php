...
@section('admin-content')
    <form action="{{ route('admin.product.update', $product->id) }}" method="post" id="edit_form"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <x-admin.form-input id="product_code" name="product_code"
                                        ...
                                        value="{{ old('product_code', $product->product_code) }}" required="true" />
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    <x-admin.form-select name="unit" id="unit" class="select2"
                                        ...
                                        @foreach ($units as $unit)
                                            <x-admin.select-option :value="$unit" :selected="old('unit', $product->unit) === $unit" :text="$unit" />
                                        @endforeach
                                    </x-admin.form-select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    <x-admin.form-select name="category_id" id="category_id" class="select2"
                                        ...
                                        @foreach ($categories as $category)
                                            <x-admin.select-option :value="$category->id" :selected="old('category_id', $product->category_id) == $category->id" :text="$category->name" />
                                        @endforeach
                                    </x-admin.form-select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    <x-admin.form-select name="sub_category_id" id="sub_category_id" class="select2"
                                        ...
                                        @foreach ($subCategories as $subCategory)
                                            <x-admin.select-option :value="$subCategory->id" :selected="old('sub_category_id', $product->sub_category_id) ==
                                                $subCategory->id" :text="$subCategory->name" />
                                        @endforeach
                                    </x-admin.form-select>
                                </div>
                            </div>
                ...
                <div class="card mt-5">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <div class="mt-3">
                                    <x-admin.form-switch name="status" label="{{ __('Status') }}" :checked="old('status', $product->status) == 1" />
                                </div>
                            </div>
                        </div>
                    </div>
