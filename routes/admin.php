...
Route::group(['as' => 'admin.', 'prefix' => 'admin', 'middleware' => ['translation']], function () {
    ...
    Route::middleware(['auth:admin'])->group(function () {
        ...
        Route::controller(AdminProfileController::class)->group(function () {
            Route::get('profile', 'edit_profile')->name('edit-profile');
            ...
            Route::delete('profile-delete', 'profile_delete')->name('profile-delete');
        });
        ...
        Route::resource('user', AdminController::class)->except('show')->names('admin');
