...
@section('title')
    {{ __('Forget Password') }} || {{ $setting->app_name }}
@endsection

@section('website-content')
    @include('website::components.breadcrumb', ['title' => __('Forget Password')])
                            ...
                            <div class="col-xl-12">
                                <div class="login_text">
                                    ...
                                    <form method="POST" action="{{ route('forget-password') }}">
                                        ...
                                        @endif
                                        <button class="common_btn" type="submit">{{ __('Forget Password') }}</button>
                                        <a href="{{ route('login') }}"
